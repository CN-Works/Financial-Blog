...
@section('pagecontent')
    <div class="w-full min-h-svh flex flex-col items-center gap-11 py-24 px-2.5">
        ...
        <div class="h-fit w-full flex items-center justify-center gap-9 flex-wrap md:justify-start">
            
            <div class="w-4/5 aspect-[3/4] flex items-center justify-center overflow-hidden rounded-3xl sm:w-3/5 md:h-96 md:w-auto xl:w-1/5 xl:h-auto">
